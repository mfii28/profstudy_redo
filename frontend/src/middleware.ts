...
export async function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' http://localhost:8000 http://127.0.0.1:8000 https://*.supabase.co wss://*.supabase.co https://*.firebaseio.com https://*.googleapis.com https://*.firebase.google.com wss://*.firebaseio.com https://cdn.mytestingdomain.icu https://*.r2.cloudflarestorage.com https://*.r2.dev https://unpkg.com https://source.zoom.us wss://*.zoom.us wss://*.zoomgov.com https://*.zoom.us https://*.zoomgov.com https://*.replit.dev https://*.repl.co https://*.replit.app https://*.onrender.com https://vercel.live https://*.vercel.app",
