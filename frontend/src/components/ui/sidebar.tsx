...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        'h-9 w-full bg-sidebar-accent border-sidebar-border shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring placeholder:text-muted-foreground/80',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      'ml-auto flex h-5 min-w-5 items-center justify-center rounded-md px-1.5 text-xs font-medium tabular-nums text-sidebar-primary-foreground select-none pointer-events-none bg-sidebar-primary',
